...
const renderListMarkup = async listType => {
  ...
  const markup = ringBuseslist.map(bus => {
    ...
    if (
      ...
      <p class="schedule__warning">Зверніть увагу, що дата прибуття може не співпадати, час подорожі залежить від завантаженості доріг, погодних умов та ситуації на кордоні.</p>
        <thead>
